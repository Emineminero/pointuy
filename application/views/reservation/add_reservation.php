		...
		<div class="row">
			...
			<div class="col-lg-12">
				...
				<section class="panel">
					...
					<form method="POST" action="<?php echo site_url('reservation/ReservationController/save'); ?>" id="resrvation_form" novalidate="novalidate">
                            ...
                            <div id="room_details">
                            	...
                            	<div class='room_row'>
									...
									<div class='onerow'>
										...
										<input type='number' class='form-control' name='no_of_persons[]' min='0' value="<?php echo
									...
									<div class='onerow'>
										...
										<input class='form-control' id='room_no' name='room_nos[]' value="<?php echo !empty(

										$rooms[4]) ? $rooms[4] : ''; ?>" placeholder='room no' style='width:
                            ...
                            <div class="row">
                            	...
                            	<div class="col-lg-4">
                                	...
                                	<input type="date" class="form-control" name="deadline_date" value="<?php echo !empty($fields['deadline_date']) ? $fields['deadline_date'] : ''; ?>" required />
                            ...
                            <div class="row">
                            	...
                            	<div class="col-lg-4">
                                	...
                                	<input type="time" class="form-control" name="arrival_time" value="<?php echo !empty($fields['arrival_time']) ? $fields['arrival_time'] : ''; ?>" required />
                            	...
                            	<div class="col-lg-4">
                                	...
                                	<textarea class="form-control" name="observation" rows="4"  required><?php echo !empty($fields['observation']) ? $fields['observation'] : ''; ?></textarea>
